...
const sectionList: Array<{
  ...
  { id: "projects", label: "Проекты", icon: FilmIcon },
  { id: "news", label: "Новости", icon: NewspaperIcon },
  { id: "updates", label: "Обновления", icon: BellIcon },
  { id: "account", label: "Аккаунт", icon: ShieldUserIcon },
  { id: "settings", label: "Настройки", icon: Settings2Icon },
]

export function Sidebar({ news, activeSection, onSectionChange }: SidebarProps) {
  return (
    <aside
    ...
    >
      <Card className="glass-panel border-white/12 bg-white/4 backdrop-blur-xl">
        <CardHeader>
          <CardTitle className="text-sm text-zinc-300">Профиль рабочей области</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400">Руководитель креативных операций</p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="rounded-lg border border-white/10 bg-black/25 p-2">
              <p className="text-zinc-500">Проекты</p>
              <p className="mt-0.5 text-sm font-semibold text-zinc-100">24</p>
            </div>
            <div className="rounded-lg border border-white/10 bg-black/25 p-2">
              <p className="text-zinc-500">Клипы</p>
              <p className="mt-0.5 text-sm font-semibold text-zinc-100">184</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="glass-panel border-white/12 bg-white/4 backdrop-blur-xl">
        <CardHeader>
          <CardTitle className="text-sm text-zinc-300">Разделы</CardTitle>
        </CardHeader>
